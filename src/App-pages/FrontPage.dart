...
import '/profile_6/profile6_widget.dart';
import 'dart:math';
import 'dart:ui';
...
class _FrontPageWidgetState extends State<FrontPageWidget>
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<DailyConsumptionRecord>>(
      stream: queryDailyConsumptionRecord(
        queryBuilder: (dailyConsumptionRecord) =>
            dailyConsumptionRecord.orderBy('drink'),
      ),
      builder: (context, snapshot) {
        ...
        List<DailyConsumptionRecord> frontPageDailyConsumptionRecordList =
            snapshot.data!;
        ...
        return GestureDetector(
          ...
          child: Scaffold(
            ...
            backgroundColor: Color(0xFFF1F4F8),
            appBar: AppBar(
              backgroundColor: Color(0xFF5E9E9A),
            ...
            body: SafeArea(
              ...
              child: Column(
                ...
                children: [
                                              ...
                                              children: [
                                                ...
                                                Padding(
                                                  padding: EdgeInsetsDirectional
                                                      .fromSTEB(0, 8, 0, 0),
                                                  child: Text(
                                                    '${FFAppState().waterTotal.toString()} l',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .displaySmall
                                                        .override(
                                              ...
                                              children: [
                                                ...
                                                Padding(
                                                  padding: EdgeInsetsDirectional
                                                      .fromSTEB(0, 8, 0, 0),
                                                  child: Text(
                                                    '${FFAppState().drinkCoffee.toString()} l',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .displaySmall
                                                        .override(
                  ...
                  Padding(
                    padding: EdgeInsetsDirectional.fromSTEB(16, 5, 16, 4),
                    child: Container(
                      width: double.infinity,
                      decoration: BoxDecoration(
                        color: Color(0xFF143C57),
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              '${FFAppState().drinkTotal.toString()} liters of liquid',
                            ...
                            Padding(
                              ...
                              child: LinearPercentIndicator(
                                percent: functions.divide(
                                    FFAppState().waterTotal, 2.8)!,
                                width: MediaQuery.sizeOf(context).width * 0.82,
                                lineHeight: 16,
                                animation: true,
                                animateFromLastPercent: true,
                                progressColor: Color(0xFF194E73),
                                backgroundColor:
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              padding: EdgeInsetsDirectional
                                                  .fromSTEB(0, 0, 16, 0),
                                              child: Text(
                                                '${FFAppState().maxCoffee.toString()} l',
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .bodyMedium
                                                    .override(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => Profile6Widget(),
                                    ),
                                  );
                                },
                                text: '',
